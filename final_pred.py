...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Hand Gesture Reecognition")
        self.root.protocol('WM_DELETE_WINDOW', self.destructor)
        self.root.geometry("1200x750")  # Increased window size to fit everything

        # Main Camera Feed Panel
        self.panel = tk.Label(self.root)
        self.panel.place(x=100, y=3, width=480, height=360)

        # Processed Hand Gesture Output Panel
        self.panel2 = tk.Label(self.root)
        self.panel2.place(x=700, y=50, width=400, height=300)
        ...
        self.panel5 = tk.Label(self.root)  # Sentence Display
        self.panel5.place(x=180, y=450)

        # Suggestions Label
        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=500)
        self.T4.config(text="Suggestions :", fg="red", font=("Courier", 20, "bold"))

        # Suggestion Buttons
        self.b1 = tk.Button(self.root, text="Option 1")
        self.b1.place(x=200, y=500, width=150, height=40)

        self.b2 = tk.Button(self.root, text="Option 2")
        self.b2.place(x=360, y=500, width=150, height=40)

        self.b3 = tk.Button(self.root, text="Option 3")
        self.b3.place(x=520, y=500, width=150, height=40)

        self.b4 = tk.Button(self.root, text="Option 4")
        self.b4.place(x=680, y=500, width=150, height=40)

        # Speak & Clear Buttons
        self.speak = tk.Button(self.root, text="Speak", font=("Courier", 15), command=self.speak_fun)
        self.speak.place(x=880, y=500, width=100, height=40)

        self.clear = tk.Button(self.root, text="Clear", font=("Courier", 15), command=self.clear_fun)
        self.clear.place(x=1000, y=500, width=100, height=40)
